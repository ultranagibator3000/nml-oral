    ...
    <div className="dark:bg-black bg-white min-h-screen flex flex-col">
      ...
      <div className="relative isolate px-4 md:px-6 pt-16 md:pt-24 lg:px-8 flex-1">
        ...
        <div className="p-6 md:p-12 justify-between w-full flex flex-col">
          <h2 className={`${unbounded_bold.className} dark:text-yellow-400 antialiased leading-10 font-bold mt-8 tracking-tighter text-gray-900 text-3xl md:text-4xl lg:text-5xl`}>
            About tournament
          </h2>
        </div>
        <div className="inline-block align-baseline p-6 md:p-12 space-y-8 lg:text-medium my-4 md:my-6">
          <p className={`${unbounded_semibold.className} dark:text-yellow-400 antialiased font-medium leading-8 text-black text-base md:text-lg w-full md:w-3/4 lg:w-1/2`}>
          ...
          <p className={`${unbounded_semibold.className} dark:text-yellow-400 antialiased font-bold leading-8 font-medium text-black text-base md:text-lg w-full md:w-3/4 lg:w-96`}>
